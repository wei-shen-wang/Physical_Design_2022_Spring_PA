...
public:
    ...
    Partitioner(fstream& inFile) :
        ...
        _accGain(0), _maxAccGain(0), _iterNum(0), _flag(false) {
        parseInput(inFile);
        _partSize[0] = 0;
        _partSize[1] = 0;
    }
    ...
    void Update_Gain(Node* &head, Node* &tail, Cell* &tempcell, Net* &tempnet, Cell* &basecell);
    void insertNode(Cell* &tempcell);
    void removeNode(Cell* &tempcell);
    void updateMaxGainCell();
